...
def create_applied_loadings(Names):
    ...
    # For eps 11
    ones_except_0 = np.array(sorted(list(set(np.linspace(0,1,Names.NUM_STEPS_EACH_MODEL[0]+1)) - set([0]))))
    zeros = np.zeros(Names.NUM_STEPS_EACH_MODEL[0])
    ...
    # For eps 22
    ones_except_0 = np.array(sorted(list(set(np.linspace(0,1,Names.NUM_STEPS_EACH_MODEL[1]+1)) - set([0]))))
    zeros = np.zeros(Names.NUM_STEPS_EACH_MODEL[1])
    ...
    # For eps 33
    ones_except_0 = np.array(sorted(list(set(np.linspace(0,1,Names.NUM_STEPS_EACH_MODEL[2]+1)) - set([0]))))
    zeros = np.zeros(Names.NUM_STEPS_EACH_MODEL[2])
    applied_strain = {11: zeros,
                      12: zeros,
                      13: zeros,
                      21: zeros,
    ...
    # For eps 12
    ones_except_0 = np.array(sorted(list(set(np.linspace(0,0.5,Names.NUM_STEPS_EACH_MODEL[3]+1)) - set([0]))))
    zeros = np.zeros(Names.NUM_STEPS_EACH_MODEL[3])
    applied_strain = {11: zeros,
                      12: ones_except_0,
                      13: zeros,
                      21: ones_except_0,
    ...
    # For eps 13
    ones_except_0 = np.array(sorted(list(set(np.linspace(0,0.5,Names.NUM_STEPS_EACH_MODEL[4]+1)) - set([0]))))
    zeros = np.zeros(Names.NUM_STEPS_EACH_MODEL[4])
    applied_strain = {11: zeros,
                      12: zeros,
                      13: ones_except_0,
                      21: zeros,
    ...
    # For eps 23
    ones_except_0 = np.array(sorted(list(set(np.linspace(0,0.5,Names.NUM_STEPS_EACH_MODEL[5]+1)) - set([0]))))
    zeros = np.zeros(Names.NUM_STEPS_EACH_MODEL[5])
    applied_strain = {11: zeros,
                      12: zeros,
                      13: zeros,
                      21: zeros,
...
def applyMechanicalPBC(Model,pairsOfNodesetNames,Names):
    ...
    for nodeSetPairNames, pairOfSortedNodeLists in zip(pairsOfNodesetNames, pairedNodes):
            ...
            for sortedNodesetName, sortedNodes in zip(pairsOfSortedNodesetNames[-1], pairOfSortedNodeLists):
                ...
                a.SetFromNodeLabels(name=str(sortedNodesetName), nodeLabels=((Names.INSTANCE_NAME, tuple(set_nodes)), ), 
                        unsorted=True)
